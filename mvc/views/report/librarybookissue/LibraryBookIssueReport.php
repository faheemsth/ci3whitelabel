                                ...
                                <?php
                                    ...
                                    foreach($getLibrarybookissueReports as $getLibrarybookissueReport) { $i++; ?>
                                        <tr>
                                            ...
                                            <td data-title="<?=$this->lang->line('librarybookissuereport_name')?>"><?=getNameByUsertypeIDAndUserID($getLibrarybookissueReport->usertypeID,$getLibrarybookissueReport->userID)?>
                                            (<?=$usertypes[$getLibrarybookissueReport->usertypeID]?>)</td>
