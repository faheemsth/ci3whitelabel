...
<div class="card">
    <div class="card-header">
        <h3 class="card-title"><i class="fa fa-diamond"></i> <?=$this->lang->line('panel_title')?></h3>
        <ol class="breadcrumb">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="form-group mb-7 col-sm-4" id="classesDiv">
                    <label>Select Memeber Type<span class="text-red"> * </span></label>
                    <?php
                        $array = array("0" => $this->lang->line("certificatereport_please_select"));
                        if(customCompute($membertypes)) {
                            foreach ($membertypes as $membertype) {
                                 $array[$membertype->regtypeID] = $membertype->regtype;
                            }
                        }
                        echo form_dropdown("membertype", $array, set_value("membertype"), "id='membertype' class='form-control bg-transparent select2'");
                     ?>
                </div>

                

                <div class="form-group mb-7 col-sm-4" >
                    <label>Select Template<span class="text-red"> * </span></label>
                    <?php
                        ...
                        echo form_dropdown("templateID", $templateArray, set_value("templateID"), "id='templateID' class='form-control bg-transparent select2'");
                     ?>
                </div>
