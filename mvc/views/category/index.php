                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-2"><?=$this->lang->line('category_title')?></th>
                                <?php if(permissionChecker('category_edit') || permissionChecker('category_delete') || permissionChecker('category_view')) { ?>
                        ...
                        <tbody>
                            <?php if(count($categorys)) {$i = 1; foreach($categorys as $category) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('category_title')?>">
                                        <?=$category->category;?>
                                    </td>
                                    <?php if(permissionChecker('category_edit') || permissionChecker('category_delete') || permissionChecker('category_view')) { ?>

                                        <td data-title="<?=$this->lang->line('action')?>">
                                            <?php echo btn_view('category/view/'.$category->categoryID, $this->lang->line('view')) ?>
