                                ...
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('action')?>">
                                        <?php
                                            ...
                                            ?>
                                        <?php if(($siteinfos->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1) || ($this->session->userdata('usertypeID') == 5)) { ?>
                                            <?php if($maininvoice->maininvoicestatus != 1 && $maininvoice->maininvoicestatus != 2 && $maininvoice->maininvoice_status == 1) { echo btn_edit('invoice/edit/'.$maininvoice->maininvoiceID, $this->lang->line('edit')); } ?>
                                        ...
                                        <?php } ?>
                                        <?php if(permissionChecker('invoice_view')) { if($maininvoice->maininvoicestatus != 2 && $maininvoice->maininvoice_status == 1) { echo btn_invoice('invoice/payment/'.$maininvoice->maininvoiceID, $this->lang->line('payment')); }} ?>
                                        <?php 
