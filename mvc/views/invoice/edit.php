                                    ...
                                    foreach ($all_feebreakups as $invoice) {
                                        ...
                                        echo '<tr id="tr_'.$randID.'" invoicefeetypeID="'.$invoice['feetypeID'].'">';
                                            ...
                                            echo '<td>';
                                                ...
                                                echo '<input name="fee_amount[]" type="text" class="form-control change-amount" id="td_amount_id_'.$randID.'" data-amount-id="'.$randID.'" value="'.$invoice['fee_amount'].'">';
                                            echo '</td>';
...
<script type="text/javascript">
    ...
    function totalInfo() {
        ...
        $('#feetypeList tr').each(function(index, value) {
            var amount = parseFloat($(this).find('input.change-amount').val());
            var discount = parseFloat($(this).find('input.change-discount').val());
            var subtotal = 0;
           ...
           if (amount < discount) {
            ...
            $(this).children().eq(5).text(subtotal);
            //    alert('a-'+amount);
            // alert('d-'+discount);
            // alert('st-'+subtotal);
            totalSubtotal += subtotal;
...
<script type="text/javascript">
    ...
    $(document).on('click', '#editInvoiceButton', function() {
        ...
        var feetypeitems = $('tr[id^=tr_]').map(function(){
            if($(this).children().eq(5).text() != '' && $(this).children().eq(5).text() != null) {
                totalsubtotal += parseFloat($(this).children().eq(5).text());
            }
            ...
            return { feetypeID : $(this).attr('invoicefeetypeid'), amount: $(this).children().eq(3).children().val(), discount : $(this).children().eq(4).children().val(), subtotal: $(this).children().eq(5).text() , paidamount: $(this).children().eq(6).children().val() };
        }).get();
