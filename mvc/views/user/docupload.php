<!--begin::Form-->
<form class="form w-100" novalidate="novalidate" method="post" id="kt_upload_docs_form"  action=""  enctype="multipart/form-data">
    <!--begin::Heading-->
    <div class="text-center mb-11">
        <!--begin::Title-->
        <h1 class="text-dark fw-bolder mb-3">Upload Documents</h1>
        <!--end::Title-->
        <!--begin::Subtitle-->
   ...
   <div class="row">
    ...
    <div class="d-grid mb-10">
        <button type="submit" value="register" id="kt_upload_docs_submit" class="btn btn-primary">
    ...
    <a href="<?php echo base_url('user/register') ?>" class="link-primary fw-semibold">Sign Up</a></div>
    <!--end::Sign up-->
</form>
<!--end::Form-->