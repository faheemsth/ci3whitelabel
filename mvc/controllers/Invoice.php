...
"username" => $username,
            ...
            if (customCompute($student)) {
                $this->data["maininvoices"] = $this->maininvoice_m->get_maininvoice_with_studentrelation_by_studentID(
    $student->studentID,
    $schoolyearID);
...
"srschoolyearID" => $schoolyearID,
            ...
            if (customCompute($students)) {
                ...
                $this->data["maininvoices"] = $this->maininvoice_m->get_maininvoice_with_studentrelation_by_multi_studentID(
    $studentArray,
    $schoolyearID);
                $this->data["grandtotalandpayment"] = $this->grandtotalandpaid(
    $this->data["maininvoices"],
    ...
    $this->data[
        "allsection"
                    ] = $this->section_m->get_order_by_section([
        "classesID" => $classesID,
                    ]);
                }
    ...
    $this->data[
        "allstudents"
                    ] = $this->studentrelation_m->get_order_by_student(
        $studentArrays
);
                }
    ...
    $this->data["end_date"] = $end_date;
                ...
                $count = $this->maininvoice_m->get_maininvoice_with_studentrelation_by_array(
                    0,
                    0,
    $schoolyearID,
    "count",
           ...
           $fee_breakup    =   serialize($breakup_info_ar);
            ...
            $this->invoice_m->update_invoice_by_maininvoiceID($data,$inv->maininvoiceID);
                ...
                $journal_items_ar[]  = array(
                                                ...
                                                'referenceID'   =>  $in_ar['maininvoiceID'],            'reference_type'=>  'invoice',            'account'       =>  $in_ar['account_credit'], 
                ...
                $journal_items_ar[]  = array(
                                                'journal'       =>  $journal_entries_id, 
                                                'referenceID'   =>  $in_ar['maininvoiceID'],            'reference_type'=>  'invoice',            'feetypeID'     =>  $in_ar['feetypeID'],             'account'      =>  $in_ar['account_debit'], 
                                                'description'   =>  $in_ar['description'], 
                                                'debit'         =>  $in_ar['net_fee'], 
                                                'entry_type'    =>  'DR', 
                                                'credit'        =>  0, 
                ...
                $student_ledgers_ar[]  = array(
                            'journal_entries_id'       =>  $journal_entries_id, 
                            'maininvoice_id'           =>  $in_ar['maininvoiceID'], 
                            'reference_type'           =>  'invoice','feetypeID'                =>  $in_ar['feetypeID'],  
                            'date'                     =>  date('Y-m-d',strtotime($in_ar['date'])), 
                            'type'                     =>  'DR', 
                ...
                $student_ledgers_ar[]  = array(
                            ...
                            'narration'                =>  $in_ar['description'], 
                            'debit'                    =>  0, 
                            'reference_type'           =>  'invoice','feetypeID'                =>  $in_ar['feetypeID'],'credit'                   =>  $in_ar['discount'], 
                ...
                $student_ledgers_ar[]  = array(
                            ...
                            'debit'                    =>  $in_ar['discount'], 
                            'credit'                   =>  0, 
                            'reference_type'           =>  'invoice','feetypeID'                =>  $in_ar['feetypeID'],'balance'                  =>  $in_ar['discount'],  
                            'created_at'               =>  date('Y-m-d h:i:s'), 
                            'updated_at'               =>  date('Y-m-d h:i:s'), );
...
"srschoolyearID" => $schoolyearID,
    ...
    $schoolyearID);
            ...
            if (isset($_POST["searchInvoice"])) {
                ...
                $count = $this->maininvoice_m->count_maininvoice_with_studentrelation(
    $schoolyearID,
    "invoice",
    $searchInvoice);
    ...
    $yearly);
                ...
                if (
    $this->session->userdata("searchInvoice") != null &&
    $this->uri->segment(2)) {
                    // $this->uri->segment ( 2 )
    ...
    $returns = $this->paginationCompress(
        "invoice/",
        $count,
                        10
);
    $this->data[
        "maininvoices"
                    ] = $this->maininvoice_m->get_maininvoice_with_studentrelation_pag(
        $returns["page"],
        $returns["segment"],
        $schoolyearID,
        "invoice",
...
"js" => ["assets/datepicker/datepicker.js",
    "assets/select2/select2.js",],
            ...
            $this->data["classes"] = $this->classes_m->general_get_classes();
            $this->data["feetypes"] = $this->feetypes_m->get_order_by_feetypes([
"type" => 1,
            ]);
            $this->data["students"] = [];
...
"js" => ["assets/datepicker/datepicker.js",
    "assets/select2/select2.js",],
        ...
        $this->data["feetypes"] = pluck($this->feetypes_m->get_feetypes(),
            "obj",
            "feetypesID");
        $this->data["students"] = $this->studentrelation_m->get_order_by_studentrelation(["srclassesID" =>                $this->data["maininvoice"]->maininvoiceclassesID,
                "srschoolyearID" => $schoolyearID,]);
    ...
    "maininvoicedeleted_at" => 1,]);
        ...
        $this->maininvoice_m->update_maininvoice(["maininvoicedeleted_at" => 0],
            $maininvoiceID);
        $this->invoice_m->update_invoice_by_maininvoiceID(["deleted_at" => 0],
            $maininvoiceID);
        $del_array = array( 
                                                'reference_type'    => 'invoice', 
...
"feetypesID"
    ...
    $this->data[
        "maininvoice"
                    ] = $this->maininvoice_m->get_maininvoice_with_studentrelation_by_maininvoiceID(
        $id,
        $schoolyearID
);
                    if (
                        customCompute($this->data["maininvoice"]) &&
        $this->data["maininvoice"]->maininvoicestudentID ==
            $getstudent->studentID
) {
        $this->data["invoices"] = $this->invoice_m->get_order_by_invoice(["maininvoiceID" => $id,
                        ]);

        $this->data["grandtotalandpayment"] = $this->grandtotalandpaidsingle($this->data["maininvoice"],
            $schoolyearID,
            $this->data["maininvoice"]->maininvoicestudentID);
        ...
        $this->data["createuser"] = getNameByUsertypeIDAndUserID($this->data["maininvoice"]->maininvoiceusertypeID,
    ...
    $this->data[
        ...
        $schoolyearID
                    ...
                    if ($this->data["maininvoice"]) {
                        if (in_array($this->data["maininvoice"]->maininvoicestudentID,
                $fetchStudent)) {
            $this->data["invoices"] = $this->invoice_m->get_order_by_invoice(["maininvoiceID" => $id,]);
    ...
    $this->load->view("_layout_main", $this->data);
            ...
            $id = htmlentities(escapeString($this->uri->segment(3)));
            if ((int) $id) {
                $this->data["maininvoice"] = $this->maininvoice_m->get_maininvoice_with_studentrelation_by_maininvoiceID(
    $id,
    $schoolyearID);
                $this->data["invoices"] = $this->invoice_m->get_order_by_invoice(["maininvoiceID" => $id,]);
                ...
                if (customCompute($this->data["maininvoice"])) {
    $this->data[
        "grandtotalandpayment"
                    ] = $this->grandtotalandpaidsingle(
        $this->data["maininvoice"],
        $schoolyearID,
        $this->data["maininvoice"]->maininvoicestudentID
);
    ...
    $this->data[
        "student"
                    ] = $this->student_m->get_single_student([
        "studentID" =>$this->data["maininvoice"]->maininvoicestudentID,
                    ]);
...
"feetypesID");
    ...
    $getstudent = $this->studentrelation_m->get_single_student([
        ...
        $this->data["maininvoice"] = $this->maininvoice_m->get_maininvoice_with_studentrelation_by_maininvoiceID($id,
            ...
            $this->data["invoices"] = $this->invoice_m->get_order_by_invoice(["maininvoiceID" => $id,]);
            $user_visit =
                $this->data["invoices"][0]->user_c == ""        ? 1
                                    : $this->data["invoices"][0]->user_c + 1;
            $this->invoice_m->update_invoice_by_maininvoiceID(["user_c" => $user_visit],
                $id);
                            // echo '<pre>';
            ...
            $this->voucherPDF("vouchermodule.css",
                $this->data,
    ...
    $fetchStudent = pluck(
        ...
        $this->data["maininvoice"] = $this->maininvoice_m->get_maininvoice_with_studentrelation_by_maininvoiceID($id,
            $schoolyearID);
                ...
                $this->reportPDF("invoicemodule.css",$this->data,
                    "invoice/print_preview");
                            } else {
                $this->data["subview"] = "error";
                $this->load->view("_layout_main", $this->data);
...
"feetypesID"
    ...
    $getstudent->studentID) {
            ...
            $fetchStudent = pluck($getStudents,
                ...
                $this->data["maininvoice"] = $this->maininvoice_m->get_maininvoice_with_studentrelation_by_maininvoiceID($id,$schoolyearID);
                                if (customCompute($this->data["maininvoice"])) {
                                    if (in_array($this->data["maininvoice"]
                                                ->maininvoicestudentID,        $fetchStudent
                    )) {
        $f = true;
                                    }
                                }
        ...
        $id = $this->input->post("id");
            ...
            $this->data["invoices"] = $this->invoice_m->get_order_by_invoice(["maininvoiceID" => $id,]);
                ...
                $this->reportSendToMail("invoicemodule.css",$this->data,
                    "invoice/print_preview",$to,$subject,$message);
    ...
    $finestatus = true;
            ...
            $amount = 0;
                            if (isset($invoicepaymentandweaver["totalamount"][
        $invoice->invoiceID])) {
                $amount +=
                        ...
                        "totalamount"        ][$invoice->invoiceID];
                            ...
                            if (isset($invoicepaymentandweaver["totaldiscount"][
        $invoice->invoiceID])) {
                $amount -=
                                    (float) $invoicepaymentandweaver[
                        "totaldiscount"        ][$invoice->invoiceID];
                            }

                            if ((float) $amount <
                                (float) ((float) $this->input->post("paidamount_" . $invoice->invoiceID) +
                                    (float) $this->input->post("weaver_" . $invoice->invoiceID))) {
                                if ($this->input->post("paidamount_" . $invoice->invoiceID) != "") {
    ...
    $this->form_validation->set_message(
        ...
        "The amount is required."
            ...
            if ($this->_amountgivenstatus) {
                if ($postValue != "") {
                    if (
                        in_array((float) $postValue,
            $this->_amountgivenstatuserror)
) {
        $this->form_validation->set_message("unique_givenamount",
            "The amount is required.");
                        return false;
                    } else {
                        return true;
...
"Voguepay",
        ...
        if ($usertypeID == 1 || $usertypeID == 5) {
            if (
                ...
                $this->form_validation->set_message(
    "check_valid_paymentmethod",
    "Payment method does not found.");
                return false;
            }
        } else {
...
"js" => ["assets/datepicker/datepicker.js",
    "assets/select2/select2.js",],
        ...
        $this->data["student"] = $this->studentrelation_m->get_single_studentrelation(["srstudentID" =>                $maininvoice->maininvoicestudentID,
                "srschoolyearID" => $schoolyearID,]);
        $this->data["studentprofile"] = $this->studentrelation_m->get_single_student(["srstudentID" => $maininvoice->maininvoicestudentID,
            "srschoolyearID" => $schoolyearID,
                        ]);
        ...
        $f = true;
                ...
                $this->data["class"] = $this->classes_m->general_get_single_classes([
                        "classesID" =>        $this->data["student"]->srclassesID,]);
                $this->data["section"] = $this->section_m->general_get_single_section([
...
if ($this->form_validation->run() == false) {
    ...
    $due =        (float) $invoicepaymentandweaver["totalamount"][$invoice->invoiceID];
        ...
        $due =            (float) ($due -
                ...
                $totalPayment = 0;
                if ($this->input->post("paidamount_" .
            $invoice->invoiceID) > 0
) {
    $totalPayment += (float) $this->input->post("paidamount_" .
            $invoice->invoiceID);
                }
    ...
    $this->weaverandfine_m->insert_weaverandfine($weaverandfineArray);
                ...
                $journal_items_ar[]  = array(
                            ...
                            'description'   =>  'Payment for Invoice'.$invoice->maininvoiceID, 
                            'feetypeID'     =>  99999, 
                            'debit'         =>  0, 
                ...
                $student_ledgers_ar[]  = array(
                            ...
                            'narration'                =>  'Payment for Invoice'.$invoice->maininvoiceID, 
                            'debit'                    =>  0, 
                            'credit'                   =>  $paymentArray['paymentamount'], 
...
"rules" => "trim|xss_clean",
    ...
    $this->data[
                        "student"        ] = $this->student_m->get_single_student([
                        "studentID" =>        $globalpayment->studentID,]);
...
"classstudent" => "Class and Student not found.",
    ...
    $rules = $this->rules($this->input->post("statusID"));
                    ...
                    if (
        $this->input->post("maininvoice_type_v") ==
            "hostel_fee" or
        $this->input->post("maininvoice_type_v") ==
            "Transport_fee"
) {
    ...
    $studentArrays["transport"] = 1;
            ...
            $automationHMember = pluck($this->hmember_m->get_hmember(),
                "obj",
                "studentID");

            $automationtmember = pluck($this->tmember_m->get_tmember(),
                "obj",
                "studentID");
    ...
    $discount_left      =   $student_discount;
           ...
           $discount_left      =   0; 
                   ...
                   $fee_discount   =   $label_amount-$fee_discount;
    $discount_left  =   0;
    ...
    $studentArray[] = $getstudent->srstudentID;
    $reg_no[$getstudent->srstudentID] =
        $getstudent->accounts_reg;
                                }
        ...
        $j = 0;
            ...
            $current_m = date("m");
                ...
                $maininvoicestd_srid =    $invoiceMainArray[$j]["maininvoicestd_srid"];
                                    ...
                                    if (!isset($ref_array[date('ym',strtotime($ref_array[date('ym',strtotime($this->input->post("date")))]))])) {
            # code...
       
         $ref_no = $this->invoice_m->get_invoice_ref_by_date($ref_array[date('ym',strtotime($this->input->post("date")))]);
        $ref_array[date('ym',strtotime( $ref_array[date('ym',strtotime($this->input->post("date")))]))] = $ref_no;
    ...
    $invoiceArray[] = [
        ...
        "maininvoiceID" =>  $invoiceMainArray[$j]["maininvoiceID"],
            ...
            $all_fee_breakups   =    unserialize($invoiceMainArray[$j][ "fee_breakup" ]);
                ...
                "refrence_no"   => $ref_array[date('ym',strtotime($invoiceMainArray[$j][ "maininvoicedate" ]))],    'description'       => $getfeetype->feetypes.' fee for semster '.$invoiceMainArray[$j]['maininvoicestd_srid'],
            ...
            $ledger_array[] = [
                ...
                "refrence_no"   => $ref_array[date('ym',strtotime($invoiceMainArray[$j][ "maininvoicedate" ]))],    'description'       => $feetype.' fee for semster '.$invoiceMainArray[$j]['maininvoicestd_srid'],
                "accounts_reg"  => $reg_no[ $invoiceMainArray[$j][ "maininvoicestudentID" ] ], 
        ...
        $maininvoicestd_srid =
            $invoiceMainArray[$j][
                                "maininvoicestd_srid"];
                                    ...
                                    // foreach ($feetypeitems as $feetypeitem) {
    $invoiceArray[] = [
                        "schoolyearID" =>        $invoiceMainArray[$j][
                                "maininvoiceschoolyearID"],
                        "classesID" =>        $invoiceMainArray[$j][
                                "maininvoiceclassesID"],
                        "studentID" =>        $invoiceMainArray[$j][
...
"totalweaver" => 0,
    ...
    $retArray["globalpayments"][
        $paymentitem->globalpaymentID][$paymentitem->paymentID] = [
...
"allpost" => $this->item_data,
    ...
    $this->data[
        "student"
                    ] = $this->studentrelation_m->get_single_studentrelation([
...
"allpost" => $this->item_data,
    ...
    $this->data[
                        "student"        ] = $this->studentrelation_m->get_single_studentrelation([
