...
class Certificate_template extends Admin_Controller {
    ...
    */
    ...
    public function add() {
        ...
        $studenttags = $this->mailandsmstemplatetag_m->get_order_by_mailandsmstemplatetag(array('usertypeID' => 18));
        $flag = '';

        if(customCompute($studenttags)) {
            foreach ($studenttags as $studenttagkey => $studenttag) {
                if($studenttag->tagname != '[result_table]')
                $flag .= '<span class="btn btn-success btn-sm mrg mx-2 mb-2" id="'.$studenttag->tagname.'">'.$studenttag->tagname.'</span>';
            }
        }
    ...
    $array = array(
        ...
        "main_middle_text"  => $_POST['main_middle_text'] ,
        "top_heading_title" => $_POST['top_heading_title'] ,
        "top_heading_left"  => $_POST['top_heading_left'] ,
        "top_heading_middle"=> $_POST['top_heading_middle'] ,
        "top_heading_right" => $_POST['top_heading_right'] ,
        "template"          => $_POST['template'],
        "footer_left_text"  => $_POST['footer_left_text'] ,
        "footer_middle_text"=> $_POST['footer_middle_text'] ,
        "footer_right_text" => $_POST['footer_right_text']  ,
        "usertypeID"        => 18,
    );
    ...
    public function view() {
        ...
        if((int)$id) {
            ...
            if($this->data['certificate_template']) {
                ...
                //$this->data["subview"] = "certificate_template/theme3";
                $this->load->view('certificate_template/theme3', $this->data);
            } else {
                $this->data["subview"] = "error";
                $this->load->view('_layout_main', $this->data);
            }
