...
var KTRegistrationGeneral = function() {
    ...
    return {
        init: function() {
            e = document.querySelector("#kt_workshop_form"), t = document.querySelector("#kt_workshop_submit"),   a = FormValidation.formValidation(e, {
                fields: {
                        ...
                        success: function(data) {
                           ...
                           if(res.return){
                            ...
                            if (t.isConfirmed) {
                                ...
                                var i = 'workshop/payment/'+ res.paymentid;
