// Define form element
const form1 = document.getElementById('kt_docs_formvalidation_image_input_workshop');
...
const submitButtons = document.getElementById('kt_docs_formvalidation_image_input_submit_workshop');
    ...
    if (validator) {
        validator.validate().then(function (status) {
            ...
            if (status == 'Valid') {
                ...
                submitButtons.setAttribute('data-kt-indicator', 'on');
                ...
                setTimeout(function () {
                    ...
                    submitButtons.removeAttribute('data-kt-indicator');
                ...
                var form_data = new FormData(document.getElementById("kt_docs_formvalidation_image_input_workshop"));
                        $.ajax({
